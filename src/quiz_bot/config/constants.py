...
ASK_BROADCAST_TEXT = 8
ASK_BROADCAST_CONFIRM = 9
ASK_EDIT_ABOUT_TEXT = 13
...
CB_ADMIN_BROADCAST = CB_ADMIN_SEND_MESSAGE
...
CB_ADMIN_USERS = CB_ADMIN_EXPORT
CB_ADMIN_USERS_PAGE_PREFIX = "admin:users:page:"
CB_BROADCAST_SEND = "broadcast:send"
CB_BROADCAST_CANCEL = "broadcast:cancel"
